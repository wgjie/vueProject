...
需要一个首页的组件。在components文件夹下定义Home.vue
...
在路由中导入home路由，在router文件下的index.js中导入：

| 导入路由                                  |
| ----------------------------------------- |
| ![1593934041909](media/1593934041909.png) |

### 编程式导航

跳转页面有两种方式，一种通过a标签，一种通过js代码跳转

### 导航守卫

vue的路由中提供了一个方法，可以在进入路由之前，进行一些判断和操作
